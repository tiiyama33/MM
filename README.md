...
信州大学理学部理学科化学コース1年・後期金曜5限(二村担当分)

|![Mordenite](/img/Mordenite.png)|
|:---:|
|ゼオライトの一種、モルデナイト(Mordenite)の結晶構造|

情報科学演習、二村担当分では 2回にわたって、コンピュータ上での「分子模型」の描画 を扱います。
...
- Tips (テクニック集)
  ...
  - [半径の切り替え](tips/radius.md)
  - [原子の番号を表示する](tips/number.md)
  - [ethanol.xyzの点線を消す](tips/ethbond.md)
  - [VESTAの表示のその他の項目](tips/settings.md)
